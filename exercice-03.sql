...
-- - OU dont la date de création est antérieure au 25 janvier 2021 inclus
SELECT *
FROM student
WHERE (email LIKE'%.fr' OR created_at <= '2021-01-26 00:00:00');
...
FROM student
WHERE email LIKE '%.fr'
AND created_at <= '2021-01-26 00:00:00' ;
-- Exo 3.3
-- Listez les students :
...
-- - ET dont la date de début est antérieure au 1er mai 2021 inclus
SELECT *
FROM project
WHERE start_date >= '2021-01-01'
AND start_date <= '2021-05-01';
